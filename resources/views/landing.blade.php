...
@section('content')
    ...
    <div class="row text-center" style="margin-top: 10rem">
        <div>
            <h1><span class="badge bg-purple-lt">made with ❤️</span></h1>
            <h1 class="display-4 fw-bold mt-3">Kelola Peminjaman Barang dengan Peenjam</h1>
            <h4 class="fw-normal mt-3 text-muted">Catat, pinjam, dan pantau aset tanpa ribet — semua dalam satu aplikasi yang
                mudah digunakan.</h4>
        </div>
...
>
    ...
    <div class="text-center" style="margin-top: 5rem">
        <img src="{{ asset('dashboard.png') }}" class="rounded-3 shadow" style="max-width: 1000px; width: 90%;"
